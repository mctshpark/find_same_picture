...
import 'package:find_same_picture/utils/constants.dart';
    ...
    if (style == CButtonStyle.basic) {
      return Container(
        ...
        child: TextButton(
          style: TextButton.styleFrom(
            primary: splashColor,
            backgroundColor: isDisabled ? c.colorPrimaryDisabled : color,
      ...
      return Container(
        ...
        child: TextButton(
          style: TextButton.styleFrom(
            primary: cWhite085,
            backgroundColor: isDisabled ? c.colorPrimaryDisabled : const Color.fromRGBO(0, 0, 0, 0),
            minimumSize: Size(width ?? MediaQuery.of(context).size.width, height ?? 48.h),
            padding: padding,
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(radius),
              side: borderSide ?? BorderSide(width: 1.w, color: tColor(Colors.black, Colors.white)),
            ),
          ),
          key: key,
          onPressed: onTap,
